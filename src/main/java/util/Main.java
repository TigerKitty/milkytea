...
public class Main {
    ...
    public static boolean trade_pay(String fukuanma, int munprice){
    ...
    // 测试当面付2.0支付
    public static boolean test_trade_pay(AlipayTradeService service, String authCode, int sumprice) {
    ...
    public String test_trade_precreate(int munprice) {
        ...
        // 业务扩展参数，目前可添加由支付宝分配的系统商编号(通过setSysServiceProviderId方法)，详情请咨询支付宝技术支持
        ExtendParams extendParams = new ExtendParams();
        extendParams.setSysServiceProviderId("2088621955628435");
