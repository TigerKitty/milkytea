...
public class YSoleNUM extends ApplicationFrame {
    ...
    {
        JFreeChart chart = ChartFactory.createBarChart3D("奶茶年销量图", // 图表标题
                "奶茶", // 目录轴的显示标签
                "销量", // 数值轴的显示标签
                dataset, // 数据集
        ...
        // 设置图显示标题
        chart.setTitle(new TextTitle("奶茶年销量图", new Font("黑体", Font.BOLD, 16)));
    ...
    {
        YSoleNUM chart=new YSoleNUM("显示界面");
        chart.pack();//以合适的大小显示
